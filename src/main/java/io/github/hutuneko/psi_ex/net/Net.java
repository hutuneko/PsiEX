...
import io.github.hutuneko.psi_ex.system.attribute.C2SSetAttribute;
import io.github.hutuneko.psi_ex.system.attribute.S2COpenEditor;
import io.github.hutuneko.psi_ex.system.attribute.S2CUpdateAttribute;
import io.github.hutuneko.psi_ex.system.capability.SyncPsionS2C;
    ...
    public static void commonSetup(final FMLCommonSetupEvent event) {
        event.enqueueWork(() -> {
            ...
            CHANNEL.messageBuilder(C2SProgrammerPagePacket.class, id++, NetworkDirection.PLAY_TO_SERVER)
                    ...
                    .add();
            CHANNEL.messageBuilder(SpellCastPacket.class, id++, NetworkDirection.PLAY_TO_SERVER)
