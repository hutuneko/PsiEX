...
public class IronsCompatModule extends AddonModule {
    ...
    private static boolean hasMySpecialSpellbook(Player p) {
        // PSI_CURIO_BULLET を装備している、または
        boolean hasBullet = CuriosUtil.findFirstByItem(p, PsiEXRegistry.PSI_CURIO_BULLET.get()).isPresent();
        // CATALYST_IRONS_SPELLBOOK を装備している
