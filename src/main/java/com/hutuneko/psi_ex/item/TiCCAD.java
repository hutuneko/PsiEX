...
public class TiCCAD extends ItemCAD implements IModifiableDisplay {
    private final ToolDefinition toolDefinition;
    protected ItemStack toolForRendering;

    public TiCCAD(Properties properties) {
        super(properties);
        this.toolDefinition = ToolDefinition.create(TiCCompatModule.TICCAD);
    }
    @Override
